...
import styles from "../styles/pages/PoliticasDePrivacidade.module.css";
    ...
    <div id="landing-page" className={styles.container}>
      ...
      <main>
        ...
        <section id="how" className={styles.how}>
          <h2 style={{ textAlign: "center" }}>Política Privacidade</h2>
          <p>
            A sua privacidade é importante para nós. É política do CadastraPet
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site{" "}
            <a href="https://cadastrapet.com.br">CadastraPet</a>, e outros sites
          ...
          <h2>Política de Cookies CadastraPet</h2>
          ...
          <p>
            ...
            informação que o CadastraPet oferece no site e com caráter
          ...
          <ul>
            ...
            <li>
              ...
              (softwares) do CadastraPet, de seus fornecedores ou terceiros,
