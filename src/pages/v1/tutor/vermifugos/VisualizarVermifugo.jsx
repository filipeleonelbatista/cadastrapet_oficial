...
export default function VisualizarVermifugo() {
  ...
  return (
    <>
      ...
      <DrawerComponent title="Visualizar Medicamento">
        <Box>
        ...
        <ContainerComponent>
          <Box sx={{
            ...
            <Button type='button' onClick={() => navigate("/tutor/historico-vermifugos/editar")} variant="contained" color="success" startIcon={<FaEdit />}>Editar</Button>
          ...
          <Box sx={{ mt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <TextField
              fullWidth
              disabled
              id="medication_application_date"
              label="Data de aplicação"
              variant="outlined"
              value={dayjs(selectedMedication?.medication_application_date).format("DD/MM/YYYY")}
            />
            ...
            <Box sx={{
              ...
              {
                selectedMedication?.medication_receipt.map((anexo, index) => (
                  <Card
