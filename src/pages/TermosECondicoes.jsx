    ...
    >
      ...
      >
        ...
        >
          ...
          <p>
            Ao acessar ao site{" "}
            <a href="https://cadastrapet.com.br">CadastraPet</a>, concorda em
          ...
          <p>
            ...
            materiais (informações ou software) no site CadastraPet , apenas
          ...
          <ol>
            ...
            <li>
              ...
              software contido no site CadastraPet;{" "}
            </li>
            <li>
          ...
          <p>
            ...
            dessas restrições e poderá ser rescindida por CadastraPet a qualquer
          ...
          <ol>
            <li>
              Os materiais no site da CadastraPet são fornecidos 'como estão'.
              CadastraPet não oferece garantias, expressas ou implícitas, e, por
            ...
            <li>
              Além disso, o CadastraPet não garante ou faz qualquer
          ...
          <h2>4. Limitações</h2>
          <p>
            Em nenhum caso o CadastraPet ou seus fornecedores serão responsáveis
            ...
            uso ou da incapacidade de usar os materiais em CadastraPet, mesmo
            que CadastraPet ou um representante autorizado da CadastraPet tenha
          ...
          <p>
            Os materiais exibidos no site da CadastraPet podem incluir erros
            técnicos, tipográficos ou fotográficos. CadastraPet não garante que
            qualquer material em seu site seja preciso, completo ou atual.
            CadastraPet pode fazer alterações nos materiais contidos em seu site
            a qualquer momento, sem aviso prévio. No entanto, CadastraPet não se
            compromete a atualizar os materiais.
          </p>
          <h2>6. Links</h2>
          <p>
            O CadastraPet não analisou todos os sites vinculados ao seu site e
            não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
            de qualquer link não implica endosso por CadastraPet do site. O uso
            de qualquer site vinculado é por conta e risco do usuário.
          </p>
          <h3>Modificações</h3>
          <p>
            O CadastraPet pode revisar estes termos de serviço do site a
