...
import styles from "../../styles/pages/vet/LoginPage.module.css";
      ...
      <div className={styles.content}>
        <div>
          ...
          <Input
            ...
            onChange={(e) => {
              setVetDocId(masks.cpf(e.target.value));
            }}
            value={vetDocId}
          />
          <Input
        ...
        <div>
          ...
          <Input
            ...
            value={petID}
          />
          <Button disabled={isDisabled} id="nome" onClick={handleSearchPet}>
            Prosseguir
          </Button>
        </div>
      </div>
