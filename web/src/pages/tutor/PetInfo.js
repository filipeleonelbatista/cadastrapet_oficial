        ...
        <div className={styles.container}>            
            ...
            <div className={styles.content}>
                <div className={styles.wContainer}>
                    ...
                    <Input disabled id="dt_nascimento" label="Data de Nascimento" value="11/01/2020" />
                    <Input disabled id="dt_adocao" label="Data de Adoção" value="11/01/2020" />

                </div>
                
                <Button id="nome" onClick={() => { }}>Editar</Button>
            </div>
        </div>
    )
}
