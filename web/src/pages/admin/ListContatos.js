...
function ListContatosComponent() {
    ...
    const {getAllContacts, getNumberOfContacts, getNumberOfContactsToday} = useConversion()
    const { getNumberOfUsers } = useAuth();
    ...
    },[getAllContacts, getNumberOfContacts, getNumberOfUsers, getNumberOfContactsToday])
                                    ...
                                    {contatos.map((contato, index) => {
                                        return (
                                            <tr key={index} className="table-row">
                                                ...
                                                <td>
                                                    {
                                                        contato.converted ? <div className="boolean-data-true"></div> : <div className="boolean-data-false"></div>
                                                    }
                                                </td>
